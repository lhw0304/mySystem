...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define('simditor', ["../../oclazyload/examples/requireJSExample/js/jquery","simple-module","simple-hotkeys","simple-uploader"], function ($, SimpleModule, simpleHotkeys, simpleUploader) {
    ...
    img.onload = (function(_this) {
      return function() {
        ...
        $img.attr({
          ...
          width: "100%",//width,
          height: "100%",//height,
          'data-image-size': 1 + ':' + (width/height).toFixed(2)
        }).removeClass('loading');
        if ($img.hasClass('uploading')) {
...
ImagePopover = (function(superClass) {
  ...
  ImagePopover.prototype.render = function() {
    ...
    // tpl = '<div id="contentContainer" class="contentContainer"></div><div id="resultContainer" class="contentContainer"></div>';
    // tpl += '<div id="light" class="edit_content"><div style="width:280px;float:left;margin-left:20px;"></div></div>'
