...
import security.AuthenticationTokenProcessingFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/v2/signup", "/v2/login","/v2/stylistDrafts/imageURL","/v2/items/**",
                "/v2/stylistDrafts/taggifiedImages/**").permitAll()
                .anyRequest().hasAnyAuthority("MERCHANT","ADMIN");
