...
! function(t) {
	...
	function c(e, s) {
		var a, o, h, n = t("<canvas>")[0],
			...
			C = d,
			b = g;
		return v && (a = d / 2, o = g / 2), w && (h = l({
			width: d,
			height: g,
			degree: u
		}), C = h.width, b = h.height, a = h.width / 2, o = h.height / 2), n.width = C, n.height = b, x && (p = -d / 2, c = -g / 2, r.save(), r.translate(a, o)), w && r.rotate(u * Math.PI / 180), v && r.scale(f, m), r.drawImage(e, yt(p), yt(c), yt(d), yt(g)), x && r.restore(), n
	}
	...
	function u(t) {
		var i, e, s, a, o, h, n, r, p, l, c = new y(t),
			d = c.byteLength;
	...
	var w = t(window),
		...
		O = "mouseup touchend touchcancel pointerup pointercancel MSPointerUp MSPointerCancel",
	...
	v.prototype = {
		...
		load: function(i) {
			...
			if (i && (o.one(j, a.build), !this.trigger(j).isDefaultPrevented())) {
				...
				if (e = t.proxy(this.read, this), Q.test(i)) return G.test(i) ? e(f(i)) : this.clone();
		...
		clone: function() {
			var i, e, s = this.options,
				...
				r = this.url,
				p = "";
			s.checkCrossOrigin && o(r) && (p = a.prop("crossOrigin"), p || (p = "anonymous", i = h(r))), this.crossOrigin = p, this.crossOriginUrl = i, this.$clone = e = t("<img" + n(p) + ' src="' + (i || r) + '">'), this.isImg ? a[0].complete ? this.start() : a.one(U, t.proxy(this.start, this)) : e.one(U, t.proxy(this.start, this)).one(I, t.proxy(this.stop, this)).addClass(T).insertAfter(a)
		},
		start: function() {
			var i = this.$element,
				e = this.$clone;
			this.isImg || (e.off(I, this.stop), i = e), r(i[0], t.proxy(function(i, e) {
				t.extend(this.image, {
					naturalWidth: i,
					naturalHeight: e,
					aspectRatio: i / e
		...
		renderCanvas: function(t) {
			...
			this.isRotated && (this.isRotated = !1, e = l({
				...
				height: n,
				degree: o
			}), s.naturalWidth = e.width, s.naturalHeight = e.height), this.limitCanvas(!0, !1))), (s.width > s.maxWidth || s.width < s.minWidth) && (s.left = s.oldLeft), (s.height > s.maxHeight || s.height < s.minHeight) && (s.top = s.oldTop), s.width = mt(vt(s.width, s.minWidth), s.maxWidth), s.height = mt(vt(s.height, s.minHeight), s.maxHeight), this.limitCanvas(!1, !0), s.oldLeft = s.left = mt(vt(s.left, s.minLeft), s.maxLeft), s.oldTop = s.top = mt(vt(s.top, s.minTop), s.maxTop), this.$canvas.css({
				width: s.width,
				height: s.height,
				left: s.left,
				top: s.top
		...
		initCropBox: function() {
			var i = this.options,
				e = this.canvas,
				s = i.aspectRatio,
				a = ft(i.autoCropArea) || .8,
				o = {
					width: e.width,
					height: e.height
				};
			s && (e.height * s > e.width ? o.height = o.width / s : o.width = o.height * s), this.cropBox = o, this.limitCropBox(!0, !0), o.width = mt(vt(o.width, o.minWidth), o.maxWidth), o.height = mt(vt(o.height, o.minHeight), o.maxHeight), o.width = vt(o.minWidth, o.width * a), o.height = vt(o.minHeight, o.height * a), o.oldLeft = o.left = e.left + (e.width - o.width) / 2, o.oldTop = o.top = e.top + (e.height - o.height) / 2, this.initialCropBox = t.extend({}, o)
		},
		limitCropBox: function(t, i) {
			var e, s, a, o, h = this.options,
				...
				d = this.cropBox,
				g = this.isLimited;
			t && (e = ft(h.minCropBoxWidth) || 0, s = ft(h.minCropBoxHeight) || 0, e = mt(e, p), s = mt(s, l), a = mt(p, g ? c.width : p), o = mt(l, g ? c.height : l), n && (e && s ? s * n > e ? s = e / n : e = s * n : e ? s = e / n : s && (e = s * n), o * n > a ? o = a / n : a = o * n), d.minWidth = mt(e, a), d.minHeight = mt(s, o), d.maxWidth = a, d.maxHeight = o), i && (g ? (d.minLeft = vt(0, c.left), d.minTop = vt(0, c.top), d.maxLeft = mt(p, c.left + c.width) - d.width, d.maxTop = mt(l, c.top + c.height) - d.height) : (d.minLeft = 0, d.minTop = 0, d.maxLeft = p - d.width, d.maxTop = l - d.height))
		},
		renderCropBox: function() {
			var t = this.options,
				...
				s = i.height,
				a = this.cropBox;
			(a.width > a.maxWidth || a.width < a.minWidth) && (a.left = a.oldLeft), (a.height > a.maxHeight || a.height < a.minHeight) && (a.top = a.oldTop), a.width = mt(vt(a.width, a.minWidth), a.maxWidth), a.height = mt(vt(a.height, a.minHeight), a.maxHeight), this.limitCropBox(!1, !0), a.oldLeft = a.left = mt(vt(a.left, a.minLeft), a.maxLeft), a.oldTop = a.top = mt(vt(a.top, a.minTop), a.maxTop), t.movable && t.cropBoxMovable && this.$face.data(tt, a.width === e && a.height === s ? ct : pt), this.$cropBox.css({
				width: a.width,
				height: a.height,
				left: a.left,
				top: a.top
		...
		output: function() {
			this.preview(), this.isCompleted ? this.trigger(q, this.getData()) : this.isBuilt || this.$element.one(S, t.proxy(function() {
		...
		bind: function() {
			var i = this.options,
				e = this.$element,
				s = this.$cropper;
			t.isFunction(i.cropstart) && e.on(A, i.cropstart), t.isFunction(i.cropmove) && e.on(N, i.cropmove), t.isFunction(i.cropend) && e.on(_, i.cropend), t.isFunction(i.crop) && e.on(q, i.crop), t.isFunction(i.zoom) && e.on(Z, i.zoom), s.on(H, t.proxy(this.cropStart, this)), i.zoomable && i.zoomOnWheel && s.on(E, t.proxy(this.wheel, this)), i.toggleDragModeOnDblclick && s.on(P, t.proxy(this.dblclick, this)), x.on(z, this._cropMove = a(this.cropMove, this)).on(O, this._cropEnd = a(this.cropEnd, this)), i.responsive && w.on(F, this._resize = a(this.resize, this))
		},
		unbind: function() {
			var i = this.options,
				e = this.$element,
				s = this.$cropper;
			t.isFunction(i.cropstart) && e.off(A, i.cropstart), t.isFunction(i.cropmove) && e.off(N, i.cropmove), t.isFunction(i.cropend) && e.off(_, i.cropend), t.isFunction(i.crop) && e.off(q, i.crop), t.isFunction(i.zoom) && e.off(Z, i.zoom), s.off(H, this.cropStart), i.zoomable && i.zoomOnWheel && s.off(E, this.wheel), i.toggleDragModeOnDblclick && s.off(P, this.dblclick), x.off(z, this._cropMove).off(O, this._cropEnd), i.responsive && w.off(F, this._resize)
		},
		resize: function() {
		...
		dblclick: function() {
			this.isDisabled || (this.$dragBox.hasClass(M) ? this.setDragMode(ct) : this.setDragMode(lt))
		},
		wheel: function(i) {
			var e = i.originalEvent || i,
				s = ft(this.options.wheelZoomRatio) || .1,
				a = 1;
			...
			if (!this.isDisabled) {
				if (h) {
					if (e = h.length, e > 1) {
						...
						n = h[1], this.startX2 = n.pageX, this.startY2 = n.pageY, s = dt
					}
					n = h[0]
				}
				if (s = s || t(n.target).data(tt), K.test(s)) {
					...
					i.preventDefault(), this.action = s, this.cropping = !1, this.startX = n.pageX || o && o.pageX, this.startY = n.pageY || o && o.pageY, s === lt && (this.cropping = !0, this.$dragBox.addClass(L))
				}
			}
		},
		cropMove: function(t) {
			...
			if (!this.isDisabled) {
				...
				if (h) {
					...
					t.preventDefault(), this.endX = o.pageX || s && s.pageX, this.endY = o.pageY || s && s.pageY, this.change(o.shiftKey, h === dt ? t : null)
				}
			}
		},
		cropEnd: function(t) {
			var i = t.originalEvent,
				e = this.action;
			this.isDisabled || e && (t.preventDefault(), this.cropping && (this.cropping = !1, this.$dragBox.toggleClass(L, this.isCropped && this.options.modal)), this.action = "", this.trigger(_, {
				originalEvent: i,
				action: e
			}))
		},
		change: function(t, i) {
			var e, s, a = this.options,
				...
				x = n.height,
				C = !0;
			switch (!o && t && (o = l && c ? l / c : 1), this.limited && (m = p.minLeft, v = p.minTop, w = m + mt(n.width, r.width), x = v + mt(n.height, r.height)), s = {
				...
				case it:
					...
					l += s.x, o && (c = l / o, g -= s.Y / 2), 0 > l && (h = et, l = 0);
					break;
				case at:
					...
					c -= s.y, g += s.y, o && (l = c * o, d += s.X / 2), 0 > c && (h = st, c = 0);
					break;
				case et:
					...
					l -= s.x, d += s.x, o && (c = l / o, g += s.Y / 2), 0 > l && (h = it, l = 0);
					break;
				case st:
					...
					c += s.y, o && (l = c * o, d -= s.X / 2), 0 > c && (h = at, c = 0);
					break;
				case nt:
					if (o) {
						if (s.y <= 0 && (v >= g || u >= w)) {
					...
					0 > l && 0 > c ? (h = ht, c = 0, l = 0) : 0 > l ? (h = rt, l = 0) : 0 > c && (h = ot, c = 0);
					break;
				case rt:
					if (o) {
						if (s.y <= 0 && (v >= g || m >= d)) {
					...
					0 > l && 0 > c ? (h = ot, c = 0, l = 0) : 0 > l ? (h = nt, l = 0) : 0 > c && (h = ht, c = 0);
					break;
				case ht:
					if (o) {
						if (s.x <= 0 && (m >= d || f >= x)) {
					...
					0 > l && 0 > c ? (h = nt, c = 0, l = 0) : 0 > l ? (h = ot, l = 0) : 0 > c && (h = rt, c = 0);
					break;
				case ot:
					if (o) {
						if (s.x >= 0 && (u >= w || f >= x)) {
					...
					0 > l && 0 > c ? (h = rt, c = 0, l = 0) : 0 > l ? (h = ht, l = 0) : 0 > c && (h = nt, c = 0);
					break;
				case ct:
				...
				case dt:
					this.zoom(function(t, i, e, s) {
						var a = bt(t * t + i * i),
							o = bt(e * e + s * s);
						return (o - a) / a
					}(wt(this.startX - this.startX2), wt(this.startY - this.startY2), wt(this.endX - this.endX2), wt(this.endY - this.endY2)), i), this.startX2 = this.endX2, this.startY2 = this.endY2, C = !1;
					break;
				case lt:
					if (!s.x || !s.y) {
						C = !1;
					...
					e = this.$cropper.offset(), d = this.startX - e.left, g = this.startY - e.top, l = p.minWidth, c = p.minHeight, s.x > 0 ? h = s.y > 0 ? ot : nt : s.x < 0 && (d -= l, h = s.y > 0 ? ht : rt), s.y < 0 && (g -= c), this.isCropped || (this.$cropBox.removeClass(X), this.isCropped = !0, this.limited && this.limitCropBox(!0, !0))
			}
			C && (p.width = l, p.height = c, p.left = d, p.top = g, this.action = h, this.renderCropBox()), this.startX = this.endX, this.startY = this.endY
		},
		crop: function() {
			this.isBuilt && !this.isDisabled && (this.isCropped || (this.isCropped = !0, this.limitCropBox(!0, !0), this.options.modal && this.$dragBox.addClass(L), this.$cropBox.removeClass(X)), this.setCropBoxData(this.initialCropBox))
		},
		reset: function() {
		...
		clear: function() {
			this.isCropped && !this.isDisabled && (t.extend(this.cropBox, {
				...
				width: 0,
				height: 0
			}), this.isCropped = !1, this.renderCropBox(), this.limitCanvas(!0, !0), this.renderCanvas(), this.$dragBox.removeClass(L), this.$cropBox.addClass(X))
		},
		replace: function(t) {
			!this.isDisabled && t && (this.isImg && (this.isReplaced = !0, this.$element.attr("src", t)), this.options.data = null, this.load(t))
		},
		enable: function() {
		...
		destroy: function() {
			var t = this.$element;
			this.isLoaded ? (this.isImg && this.isReplaced && t.attr("src", this.originalUrl), this.unbuild(), t.removeClass(X)) : this.isImg ? t.off(U, this.start) : this.$clone && this.$clone.remove(), t.removeData($)
		},
		move: function(t, i) {
			var s = this.canvas;
		...
		moveTo: function(t, s) {
			var a = this.canvas,
				o = !1;
			e(s) && (s = t), t = ft(t), s = ft(s), this.isBuilt && !this.isDisabled && this.options.movable && (i(t) && (a.left = t, o = !0), i(s) && (a.top = s, o = !0), o && this.renderCanvas(!0))
		},
		zoom: function(t, i) {
			var e = this.canvas;
			t = ft(t), t = 0 > t ? 1 / (1 - t) : 1 + t, this.zoomTo(e.width * t / e.naturalWidth, i)
		},
		zoomTo: function(t, i) {
			var e, s, a, o, h, n = this.options,
				...
				c = r.naturalWidth,
				g = r.naturalHeight;
			if (t = ft(t), t >= 0 && this.isBuilt && !this.isDisabled && n.zoomable) {
		...
		rotateTo: function(t) {
			t = ft(t), i(t) && this.isBuilt && !this.isDisabled && this.options.rotatable && (this.image.rotate = t % 360, this.isRotated = !0, this.renderCanvas(!0))
		},
		scale: function(t, s) {
			var a = this.image,
				o = !1;
			e(s) && (s = t), t = ft(t), s = ft(s), this.isBuilt && !this.isDisabled && this.options.scalable && (i(t) && (a.scaleX = t, o = !0), i(s) && (a.scaleY = s, o = !0), o && this.renderImage(!0))
		},
		scaleX: function(t) {
		...
		getCroppedCanvas: function(i) {
			...
			return this.isBuilt && this.isCropped && ut ? (t.isPlainObject(i) || (i = {}), g = this.getData(), e = g.width, s = g.height, p = e / s, t.isPlainObject(i) && (h = i.width, n = i.height, h ? (n = h / p, r = h / e) : n && (h = n * p, r = n / s)), a = yt(h || e), o = yt(n || s), l = t("<canvas>")[0], l.width = a, l.height = o, d = l.getContext("2d"), i.fillColor && (d.fillStyle = i.fillColor, d.fillRect(0, 0, a, o)), d.drawImage.apply(d, function() {
				var t, i, a, o, h, n, p = c(this.$clone[0], this.image),
					...
					f = g.x,
					m = g.y;
				return -e >= f || f > l ? f = t = a = h = 0 : 0 >= f ? (a = -f, f = 0, t = h = mt(l, e + f)) : l >= f && (a = 0, t = h = mt(e, l - f)), 0 >= t || -s >= m || m > d ? m = i = o = n = 0 : 0 >= m ? (o = -m, m = 0, i = n = mt(d, s + m)) : d >= m && (o = 0, i = n = mt(s, d - m)), u.push(yt(f), yt(m), yt(t), yt(i)), r && (a *= r, o *= r, h *= r, n *= r), h > 0 && n > 0 && u.push(yt(a), yt(o), yt(h), yt(n)), u
			}.call(this)), l) : void 0
		},
		setAspectRatio: function(t) {
			var i = this.options;
			this.isDisabled || e(t) || (i.aspectRatio = vt(0, t) || NaN, this.isBuilt && (this.initCropBox(), this.isCropped && this.renderCropBox()))
		},
		setDragMode: function(t) {
			var i, e, s = this.options;
			this.isLoaded && !this.isDisabled && (i = t === lt, e = s.movable && t === ct, t = i || e ? t : gt, this.$dragBox.data(tt, t).toggleClass(M, i).toggleClass(k, e), s.cropBoxMovable || this.$face.data(tt, t).toggleClass(M, i).toggleClass(k, e))
		}
	}, v.DEFAULTS = {
		viewMode: 0,
		dragMode: "crop",
		...
		t.extend(v.DEFAULTS, i)
	}, v.TEMPLATE = '<div class="cropper-container">'+
						...
						'</div>'+
					'</div>', v.other = t.fn.cropper, t.fn.cropper = function(i) {
		...
		return this.each(function() {
			...
			if (!n) {
				...
				e = t.extend({}, h.data(), t.isPlainObject(i) && i), h.data($, n = new v(this, e))
			}
